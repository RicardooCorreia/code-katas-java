...
public class Day8Playground {
    ...
    public Long junctionBoxes(String input, int maxNumberToConnect) {
        ...
        List<Distance> distances = getDistances(boxes, maxNumberToConnect);
        ...
        return circuitOfJunctionBoxes.values()
                .stream()
                ...
                .limit(3)
                .reduce(1L, (value1, value2) -> value1 * value2);
    }

    private List<Distance> getDistances(List<JunctionBox> boxes, int count) {
