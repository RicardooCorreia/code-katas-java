...
class Result {
    ...
    public static long taumBday(int blackAmount, int whiteAmount, int priceBlack, int priceWhite, int exchangePrice) {
        // Write your code here

        final int exchangeWhiteToBlack = priceWhite + exchangePrice;
        final int exchangeBlackToWhite = priceBlack + exchangePrice;
