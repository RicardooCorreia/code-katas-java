...
class Day11ReactorPart2Test {

    private final Day11ReactorPart2 subject = new Day11ReactorPart2();

    @Test
    void numOfPaths_example() {
        ...
        // When
        long result = subject.numOfPaths(input);
